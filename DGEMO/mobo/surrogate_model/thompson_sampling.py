...
from DGEMO.mobo.surrogate_model.gaussian_process import GaussianProcess
...
class ThompsonSampling(GaussianProcess):
    ...
    '''
    def __init__(self, n_var, n_obj, nu, n_spectral_pts, mean_sample, useInteger, **kwargs):
        super().__init__(n_var, n_obj, nu, useInteger)

        self.M = n_spectral_pts
        self.thetas, self.Ws, self.bs, self.sf2s = None, None, None, None
        self.mean_sample = mean_sample
        self.useInteger = useInteger
