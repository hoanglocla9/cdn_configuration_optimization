...
from pymoo.factory import get_mutation, get_crossover, get_sampling, get_reference_directions
...
def main():
    ...
    ea_algorithm = MOEAD(ref_dir, n_neighbors= args.batch_size,  sampling=sampling, crossover=get_crossover("int_one_point"),
