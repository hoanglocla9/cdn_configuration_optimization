import numpy as np
from DGEMO.problems import Problem
...
class SurrogateProblem(Problem):
    ...
    def _evaluate(self, x, out, parallel=False, *args, calc_gradient=False, calc_hessian=False, **kwargs):
        ...
        if not self.transformation is None:
            ...
            x_ori = x
        out['G'], out['CV'], out['feasible'] = self.real_problem.evaluate(x_ori, parallel=parallel, return_values_of=['G', 'CV', 'feasible'], requires_F=False)
