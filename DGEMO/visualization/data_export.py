...
import pandas as pd
import numpy as np
from DGEMO.mobo.utils import find_pareto_front, calc_hypervolume
from DGEMO.utils import get_result_dir
...
class DataExport:
    ...
    def update(self, X_next, Y_next):
        ...
        if not self.transformation is None:
            ...
            val = self.optimizer.surrogate_model.evaluate(X_next, std=True)
